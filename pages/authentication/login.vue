                ...
                <b-card no-body>
                  <b-tabs pills vertical>
                    <b-tab active>
                      <template #title>
                        <img
                          :src="require('~/assets/images/login/firebase.svg')"
                          id="firebase-tooltip"
                        />
                    ...
                    <b-tab>
                      <template #title>
                        <img 
                          :src="require('~/assets/images/login/auth0.svg')"
                        />
                        <span>Auth0</span>
                      </template>
                      <b-card-text>
                        <form class="theme-form">
                          <img
                            :src="require('~/assets/images/login/auth-img.svg')" />
                          ...
                          <p class="mt-4 mb-0">
                            Don't have account?<router-link class="ml-2" tag="a" to="/auth/register" >
                            Create Account
                          </router-link>
                          </p>
                        </form>
                    ...
                    <b-tab>
                      <template #title>
                        <img :src="require('~/assets/images/login/jwt.svg')" />
                        <span>JWT</span>
                      </template>
                      <b-card-text>
